...
class CoffeeOrderControllerTest {
    ...
    void shouldPlaceOrder() throws Exception {
        ...
        //Vi laver et arguemntCaptor fordi når man laver et coffeeORder objekt vil der blive tilkoblet et OrderID på
        // vi ved ikke hvad OrderID vil være, så man bruger ArgumentCaptor til at fange OrderID og verify det
        ...
        assertNotNull(captured.getOrderId()); //UUID
